...
#if defined(CONFIG_PLAT_EXYNOS5) || defined(CONFIG_PLAT_TX2) || defined(CONFIG_PLAT_IMX8MQ_EVK)
    /* HACK: See if we have a "RAM device" for 1-1 mappings */
    map_unity_ram(&vm);
#endif /* CONFIG_PLAT_EXYNOS5410 || CONFIG_PLAT_TX2 || CONFIG_PLAT_IMX8MQ_EVK */
